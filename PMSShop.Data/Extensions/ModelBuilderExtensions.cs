...
using PMSShop.Data.Enums;
using System;
using System.Collections.Generic;
using System.Text;

namespace PMSShop.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomeTittle", Value = "This is home page of PMSShop" },
                new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of PMSShop" },
                new AppConfig() { Key = "HomeDescription", Value = "This is description of PMSShop" }
                );
